...
import io.github.huangjietian.data.tabulation.annotations.Anchor;
import io.github.huangjietian.data.tabulation.annotations.Margins;
import io.github.huangjietian.data.tabulation.annotations.Palette;
...
public final class LayoutHandler extends BoxBracket implements Layouter {
    ...
    public void addTextBox(Sheet sheet, Textbox textbox) {
        ...
        io.github.huangjietian.data.tabulation.annotations.Palette fillColor = textbox.fillColor();
